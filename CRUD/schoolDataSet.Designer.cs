...
namespace CRUD {
    ...
    public partial class schoolDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int id, string firstName, string lastName, string city, string department) {
...
namespace CRUD.schoolDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([id] = @Original_id) AND ([firstName] = @Orig" +
                "inal_firstName) AND ([lastName] = @Original_lastName) AND ([city] = @Original_ci" +
                "ty) AND ([department] = @Original_department))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([id], [firstName], [lastName], [city], [department])" +
                " VALUES (@id, @firstName, @lastName, @city, @department);\r\nSELECT id, firstName," +
                " lastName, city, department FROM Student WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [id] = @id, [firstName] = @firstName, [lastName] = @lastName, [city] = @city, [department] = @department WHERE (([id] = @Original_id) AND ([firstName] = @Original_firstName) AND ([lastName] = @Original_lastName) AND ([city] = @Original_city) AND ([department] = @Original_department));
SELECT id, firstName, lastName, city, department FROM Student WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD.Properties.Settings.Default.schoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstName, lastName, city, department FROM dbo.Student";
        ...
        public virtual int Delete(int Original_id, string Original_firstName, string Original_lastName, string Original_city, string Original_department) {
        ...
        public virtual int Insert(int id, string firstName, string lastName, string city, string department) {
        ...
        public virtual int Update(int id, string firstName, string lastName, string city, string department, int Original_id, string Original_firstName, string Original_lastName, string Original_city, string Original_department) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, string city, string department, int Original_id, string Original_firstName, string Original_lastName, string Original_city, string Original_department) {
            return this.Update(Original_id, firstName, lastName, city, department, Original_id, Original_firstName, Original_lastName, Original_city, Original_department);
        }
    }
